...
public class Inmueble implements Serializable {
    ...
    private String direccion, uso, tipo;
    private int ambientes, superficie;
    ...
    public Inmueble(String direccion, String uso, String tipo, int ambientes, int superficie, double latitud, double longitud, double valor, boolean disponible) {
        this.direccion = direccion;
        this.uso = uso;
        this.tipo = tipo;
        this.ambientes = ambientes;
